# Obsidian Protocol design references

This directory preserves supplied design references and their extracted text so the game's source material remains
available for continued development.

## Current references

- `Source PDFs/OPAW-Game-Vision.pdf` — game vision and player experience
- `Source PDFs/OPAW-Production-Phases.pdf` — production phase checklist
- `Source PDFs/OPAW-Purchase-List.pdf` — credit costs, facilities, slots, modules, and upgrades
- `Source PDFs/OPAW-Carrier-Group-Map.pdf` — detailed Carrier Group map specification

The same documents are available as searchable text in `Extracted Text/`.
...
- Source PDFs/OPAW-Sea-Tidebreaker-Unit.pdf - detailed Tidebreaker heavy-assault vessel specification

- Source PDFs/OPAW-Command-Archive-Unit.pdf - detailed Archive strategic data-core specification
