...
SAMPLER(sampler_Displacement_1);

TEXTURE2D(_Displacement_2);
SAMPLER(sampler_Displacement_2);

TEXTURE2D(_Derivatives_1);
SAMPLER(sampler_Derivatives_1);

TEXTURE2D(_Derivatives_2);
SAMPLER(sampler_Derivatives_2);
...
SAMPLER(sampler_SeaFoamNormalMap);

TEXTURE2D(_SeaFoamRoughnessMap);
SAMPLER(sampler_SeaFoamRoughnessMap);
