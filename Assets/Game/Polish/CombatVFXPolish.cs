...
{
    public sealed class CombatVFXPolish
    {
        ...
        public bool Initialize()
        {
            ...
            SetDefault("MuzzleFlash", 1f);
            SetDefault("Impact", 1f);
            SetDefault("Explosion", 1f);
            SetDefault("ProjectileTrail", 1f);
            SetDefault("Smoke", 1f);
            SetDefault("Debris", 1f);
            SetDefault("DamageEffect", 1f);
